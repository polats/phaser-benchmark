...
api.post('/score', async (c) => {
  ...
  // Only keep the user's best score.
  ...
  // 1-based descending rank (highest score = rank 1). Ties are resolved by the
  // sorted set's lexical ordering; good enough for a leaderboard.
